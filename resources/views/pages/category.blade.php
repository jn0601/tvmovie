...
@section('content')
@php
   Session::put('category', $get_category->name);
   Session::put('category_link', $get_category->seo_name);
...
<div class="row container" id="wrapper">
  <div class="halim-panel-filter">
     <div class="panel-heading">
        <div class="row">
           <div class="col-xs-6">
            <div class="yoast_breadcrumb hidden-xs"><span><span>Danh mục » <span class="breadcrumb_last" aria-current="page"><a href="#">{{$get_category->name}}</a></span></span></span></div>
           </div>
        </div>
     </div>
  ...
  <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
   <section>
      <div class="section-bar clearfix">
         <h1 class="section-title"><span>{{$get_category->name}}</span></h1>
      </div>
      <div class="halim_box">
