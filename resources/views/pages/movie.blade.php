           ...
           <div class="halim-movie-wrapper">
              ...
              <div class="movie_info col-xs-12">
                 <div class="movie-poster col-md-3">
                    <img class="movie-thumb" src="{{URL::to('public/backend/uploads/movies/'.$movie_detail->image)}}" alt="{{$movie_detail->name}}">
                    <div class="bwa-content">
                       <div class="loader"></div>
                       <a href="{{route('watch', $movie_detail->seo_name)}}" class="bwac-btn">
                       <i class="fa fa-play"></i>
                       </a>
                    </div>
                 </div>
                 <div class="film-poster col-md-9">
                    <h1 class="movie-title title-1" style="display:block;line-height:35px;margin-bottom: -14px;color: #ffed4d;text-transform: uppercase;font-size: 18px;">{{$movie_detail->name}}</h1>
