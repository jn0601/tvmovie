...
@php
   ...
   Session::put('genre_link', $get_genre->seo_name);
...
<div class="row container" id="wrapper">
  <div class="halim-panel-filter">
     <div class="panel-heading">
        <div class="row">
           <div class="col-xs-6">
              <div class="yoast_breadcrumb hidden-xs"><span><span>Thể loại » <span class="breadcrumb_last" aria-current="page"><a href="#">{{$get_genre->name}}</a></span></span></span></div>
           </div>
        </div>
     </div>
