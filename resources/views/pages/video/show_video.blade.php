    ...
    <div class="page page_video">
       <div class="container">
          <div class="col-lg-6 text-center offset-lg-3">
             <h2>Thư viện video của chúng tôi</h2>
       ...
       <div class="container magnific-popup1 mt-5">
          ...
          <div class="row">
            ...
            <!-- image -->
            <div class="col-lg-3">
               <a href="{{URL::to('/'.$element->seo_name)}}" title="You can add caption to pictures.">
                  <img src="{{URL::to('public/backend/uploads/videos/'.$element->image)}}" 
