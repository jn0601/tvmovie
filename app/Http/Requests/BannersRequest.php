...
class BannersRequest extends FormRequest
{
    ...
    {
        $dataRules = [
            'name' => 'required|max:255|unique:banners,name,' . $this->banner,
            'img' => ['required' => Rule::requiredIf(empty($this->banner))],
            'seo_name' => 'required|max:255|unique:banners,seo_name,' . $this->banner,
        ];
